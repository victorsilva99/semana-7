    ...
    class CadastroCachorro
    {
        ...
        public string AdicionarCachorro(CadastroCachorro novoCachorro)
        {
            if (novoCachorro.Nome == string.Empty || novoCachorro.Idade == 0 || novoCachorro.Raca == string.Empty)
                ...
                (novoCachorro.NomeDoDono == string.Empty || novoCachorro.Email == string.Empty || novoCachorro.CPF == 0 || novoCachorro.Endereco == string.Empty)
            ...
            return $"O cadastro do Gato {novoCachorro.Nome} foi realizado com sucesso!";
        }
    }
}
